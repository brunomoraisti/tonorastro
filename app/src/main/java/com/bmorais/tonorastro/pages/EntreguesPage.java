...
public class EntreguesPage extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view =  inflater.inflate(R.layout.page_entregues, container, false);

        semEncomenda = view.findViewById(R.id.semEncomendaEntregue);
        ...
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                buscarEncomendaEntregue(getActivity());
            }
        });
    ...
    public void buscarEncomendaEntregue(Activity activity){
        ...
        executorService.execute(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    encomendasDao.abrir();
                    arrayEncomendas = encomendasDao.buscarEncomendaEntregue();
